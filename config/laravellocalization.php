...
return [
    ...
    'supportedLocales' => [
        ...
        'uz' => ['name' => 'Uzbeki',                   'script' => 'Arab', 'native' => 'ازبیکی', 'regional' => 'uz_AF'],
        'mj' => ['name' => 'Munji',                    'script' => 'Arab', 'native' => 'منجی', 'regional' => 'mj_AF'],
        'no' => ['name' => 'Nooristani',               'script' => 'Arab', 'native' => 'نورستانی', 'regional' => 'no_AF'],
        'sw' => ['name' => 'Savji',                    'script' => 'Arab', 'native' => 'سوجی', 'regional' => 'sw_AF'],
        'sh' => ['name' => 'Sheghnani',                'script' => 'Arab', 'native' => 'شغنانی', 'regional' => 'sh_AF'],
        'pa' => ['name' => 'Pashai',                   'script' => 'Arab', 'native' => 'پشه یی', 'regional' => 'pa_AF'],
    ...
    'localesOrder' => ['en', 'fa', 'ps', 'uz', 'mj', 'no', 'sw', 'sh', 'pa'],
