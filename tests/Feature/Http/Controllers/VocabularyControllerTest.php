...
class VocabularyControllerTest extends TestCase
{
    ...
    public function weight_field_is_required()
    {
        ...
        $response = $this->actingAs($user)->post(route('vocabularystore'), $this->data(['weight' => '']));
    ...
    public function update_language_field_is_required()
    {
        ...
        $response = $this->actingAs($user)->post("en/admin/vocabulary/edit/$taxonomyVocabulary->vid", $this->data(['language' => '']));
