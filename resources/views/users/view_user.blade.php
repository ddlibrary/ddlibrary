        ...
        <article>
            ...
            <form method="POST" action="{{ route('user-profile-update') }}" autocomplete="off">
                ...
                @if (Session::has('success'))
                    <div style="background: #dff0d8;border:1px solid #d6e9c6;color:#3c763d; border-radius:5px;padding:15px;margin: 10px 0px;">
                        {{ Session::get('success') }}
                    </div>
                @elseif(Session::has('warning'))
                    <div style="background: f2dede;color:#a94442; border-radius:5px;padding:15px;border:1px solid #ebccd1;margin:10px 0px">
                        {{ Session::get('warning') }}
                    </div>
                @endif
                <div class="form-item">
                ...
                <div class="form-item">
                    ...
                    <input class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password"
                        type="password" size="40" placeholder="@lang('Only fill this if you want to change your password')" autocomplete="off">
                ...
                <div class="form-item">
                    ...
                    <input class="form-control {{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}"
                        name="password_confirmation" type="password" size="40" placeholder="@lang('Only fill this if you want to change your password')"
                        autocomplete="off">
