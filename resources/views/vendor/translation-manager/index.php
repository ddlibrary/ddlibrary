...
<header class="navbar navbar-static-top navbar-inverse" id="top" role="banner">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a href="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'getIndex']) ?>" class="navbar-brand">
                Translation Manager
            </a>
        </div>
        <span class="navbar-right">
            <a href="<?php echo action([\App\Http\Controllers\DashboardController::class, 'index']) ?>" class="navbar-brand">
              Back to admin
            </a>
        </span>
    </div>
...
<div class="container-fluid">
    ...
    <p>
        <?php if(!isset($group)) : ?>
        <form class="form-import" method="POST" action="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postImport']) ?>" data-remote="true" role="form">
        ...
        <form class="form-find" method="POST" action="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postFind']) ?>" data-remote="true" role="form" data-confirm="Are you sure you want to scan you app folder? All found translation keys will be added to the database.">
            <div class="form-group">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
        ...
        <?php endif; ?>
        <?php if(isset($group)) : ?>
            <form class="form-inline form-publish" method="POST" action="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postPublish'], $group) ?>" data-remote="true" role="form" data-confirm="Are you sure you want to publish the translations group '<?php echo $group ?>? This will overwrite existing language files.">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
    ...
    <form role="form" method="POST" action="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postAddGroup']) ?>">
        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
        <div class="form-group">
    ...
    <?php if($group): ?>
        <form action="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postAdd'], [$group]) ?>" method="POST"  role="form">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            <div class="form-group">
        ...
        <form class="form-add-locale autotranslate-block-group hidden" method="POST" role="form" action="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postTranslateMissing']) ?>">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
        ...
        <table class="table">
            ...
            <?php foreach ($translations as $key => $translation): ?>
                <tr id="<?php echo htmlentities($key, ENT_QUOTES, 'UTF-8', false) ?>">
                    ...
                    <?php if ($deleteEnabled): ?>
                        <td>
                            <a href="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postDelete'], [$group, $key]) ?>"
                               class="delete-key"
    ...
    <?php else: ?>
        <fieldset>
            ...
            <form  class="form-remove-locale" method="POST" role="form" action="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postRemoveLocale']) ?>" data-confirm="Are you sure to remove this locale and all of data?">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            ...
            <form class="form-add-locale" method="POST" role="form" action="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postAddLocale']) ?>">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <div class="form-group">
                    <p>
        ...
        <fieldset>
            ...
            <form class="form-inline form-publish-all" method="POST" action="<?php echo action([\Barryvdh\TranslationManager\Controller::class, 'postPublish'], '*') ?>" data-remote="true" role="form" data-confirm="Are you sure you want to publish all translations group? This will overwrite existing language files.">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
