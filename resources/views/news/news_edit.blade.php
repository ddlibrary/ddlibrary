...
<section class="ddl-forms">
    ...
    <div class="content-body">
        ...
        <div class="form-item">
            ...
            <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" id="title" name="title" size="40" type="text" value="{{ $news->title }}" required autofocus>
            @if ($errors->has('title'))
        ...
        <div class="form-item">
            ...
            <div id="editor">
                <textarea class="form-control{{ $errors->has('body') ? ' is-invalid' : '' }}" name="body" style="height: 200px">{{ $news->body }}</textarea>
            </div>
            <script>
                var getUrl = window.location;
                var baseUrl = <?php echo json_encode(URL::to('/')); ?>;
