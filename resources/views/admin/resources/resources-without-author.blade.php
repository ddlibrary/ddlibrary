    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Resources without author</li>
            </ol>
            
            <div class="pb-4">
                <form method="get" action="{{ route('resource-without-authors') }}">
                    @csrf
                    <div class="row">
                        ...
                        {{-- Without author --}}
                        <div class="col-md-2">
                            <label>Without author</label>
                            <select class="form-control" name="without_author">
                                <option value="">...</option>
                                <option value="1"
                                    {{ isset($filters['without_author']) && $filters['without_author'] == 1 ? 'selected' : '' }}>
                                    Yes</option>
        ...
        <script>
            ...
            if(confirm('Are you sure to change the author?')){
                if (name) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            const errorMessage = xhr.responseJSON?.message || 'Failed to add author.';
                    ...
                    showToast('Please enter a author name.', 'error');
                }
            }
        }
        </script>
