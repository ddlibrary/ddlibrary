    ...
    <div class="content-body">
        ...
        <div class="form-item">
            <label for="educational_resource"> 
                <h2>2. {{ __('Educational Resource') }} {{ en('Educational Resources') }}</h2>
            </label>
        ...
        <div class="form-item">
            ...
            <label for="creative_commons"> 
                <strong>
                        {{ __('If there is Creative Commons License on the resource, select one of these') }} <br>
            ...
            @endforeach
            <div class="description">
                    {{ __('Unsure of which option to select?') }} {{ __('Click') }} <a href="{{ URL::to('/pages/view/2252') }}">{{ __('here') }}</a> {{ __('for guidance on licensing this resource.') }} <br>
        ...
        <div class="form-item">
            <label for="creative_commons_other"> 
                <strong>
                    {{ __('If there is no Creative Commons License on the resource, select one these:') }} <br>
                    {{ en('If there is no Creative Commons License on the resource, select one these') }}
                </strong>
            </label>
        ...
        <div style="display:flex;">
            <input style="margin-{{ (app()->getLocale()=="en")?"right":"left" }}: 10px;" class="form-control normalButton" type="button" value="{{ __('Previous') }} {{ en('Previous') }}" onclick="location.href='{{ URL::to('resources/add/step2') }}'">
