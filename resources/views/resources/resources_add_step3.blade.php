    ...
    <div class="content-body">
        ...
        <div class="form-item">
            <label for="educational_resource"> 
                <h2>2. @lang('Educational Resource') {{ en('Educational Resources') }}</h2>
            </label>
        ...
        <div class="form-item">
            ...
            <label for="creative_commons"> 
                <strong>
                        @lang('If there is Creative Commons License on the resource, select one of these') <br>
            ...
            @endforeach
            <div class="description">
                    @lang('Unsure of which option to select?') @lang('Click') <a href="{{ URL::to('/pages/view/2252') }}">@lang('here')</a> @lang('for guidance on licensing this resource.') <br>
        ...
        <div class="form-item">
            <label for="creative_commons_other"> 
                <strong>
                    @lang('If there is no Creative Commons License on the resource, select one these:') <br>
