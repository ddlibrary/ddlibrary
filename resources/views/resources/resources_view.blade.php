                    ...
                    <div class="resource-view-title">
                        ...
                        <div class="resource-icons">
                            <div class="resource-icons-group">
                                ...
                                @endif
                                <i class="fas fa-lg fa-star {{ $resource->favorites ? 'active' : '' }}" title="@lang('Favorite this resource')"
                                    id="resourceFavorite"
                ...
                <article class="resource-view-details">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        @if (isset($newId[$localeCode]) && $newId != 0)
                            ...
                            ?>
                            <a rel="alternate" title="language" class="user-state bg-lightseagreen"
                                hreflang="{{ $localeCode }}"
                                href="{{ LaravelLocalization::getLocalizedURL($localeCode, $newUrl, [], true) }}">
                                {{ $properties['native'] }} <span class="fa fa-check-circle"></span>
                            </a>
                        @else
                            <a rel="alternate" title="language" class="user-state bg-red-300"
                                hreflang="{{ $localeCode }}">
                                {{ $properties['native'] }} <span class="fa fa-times-circle"></span>
                            </a>
                        @endif
                    @endforeach
                </article>
            ...
            <section class="resource-view-comment">
                ...
                @foreach ($comments as $cm)
                    <article style="border:1px solid #f1f1f1; border-radius: 5px;">
                        ...
                        <span style="font-size: 10px; color: #8795a1;">Posted
                            {{ $cm->created_at->diffForHumans() }}</span>
