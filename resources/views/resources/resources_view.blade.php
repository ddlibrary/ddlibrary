            ...
            <div class="resource-view-title">
                ...
                <div class="resource-icons">
                    <div class="resource-icons-group">
                        ...
                        @endif
                        <i class="fas fa-lg fa-star pointer {{ $resource->favorites?"active":"" }}" title="@lang('Favorite this resource')" id="resourceFavorite" onclick="favorite('resourceFavorite','{{ URL::to("resources/favorite/") }}','{{ $resource->id }}','{{ Auth::id() }}')"></i>
