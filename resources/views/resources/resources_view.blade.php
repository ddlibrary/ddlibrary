...
@section('page_image')
        ...
        {{  $resource->resourceFile ?  $resource->resourceFile->path  : getImagefromResource($resource->abstract, '282x254') }}
@endsection
<style>
    .epub-container {
    ...
    <div class="container-fluid">
        ...
        <div class="row m-2 mt-md-4">
            ...
            <div class="col-md-3">
                <div class="row">
                    <div class="p-3">
                        <img class="resource-view-img" src=" {{ $resource->resourceFile ?  $resource->resourceFile->path  : getImagefromResource($resource->abstract, '282x254') }}"
