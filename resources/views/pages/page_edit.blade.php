...
<section class="ddl-forms">
    ...
    <div class="content-body">
        ...
        <div class="form-item">
            ...
            <div id="editor">
                <textarea class="form-control{{ $errors->has('body') ? ' is-invalid' : '' }}" name="body" style="height: 200px">{{ fixImage($page->body, $page->id) }}</textarea>
            </div>
            @if ($errors->has('body'))
                <span class="invalid-feedback">
        ...
        <div class="form-item">
            ...
            <input type="radio" name="published" {{ ($page->status  == 1)?"checked":""}} value="1"> {{ __('Yes') }}
            <input type="radio" name="published" {{ ($page->status == 0)?"checked":""}} value="0"> {{ __('No') }}
        </div>
        <div class="left-side">
