...
<section class="ddl-forms">
    ...
    <div class="content-body">
        ...
        <div class="form-item">
            ...
            <div id="editor">
                <textarea class="form-control editor {{ $errors->has('summary') ? ' is-invalid' : '' }}" name="summary" style="height: 200px">{{ fixImage($page->summary, $page->id) }}</textarea>
            </div>
        ...
        <div class="form-item">
            ...
            <div id="editor">
                <textarea class="form-control editor {{ $errors->has('body') ? ' is-invalid' : '' }}" name="body" style="height: 200px">{{ fixImage($page->body, $page->id) }}</textarea>
            </div>
            @if ($errors->has('body'))
                <span class="invalid-feedback">
