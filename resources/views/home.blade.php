...
@section('content')
    <div class="container pt-2" id="homepage-main-container">
            ...
            @foreach($subjectAreas as $subject)
                ...
                >
                    <div class="home-subject-areas">
                        <img src="{{ getFile('files/'.$subject->file_name) }}" alt="Subject Area Icon">
                        <p>{{ $subject->name }}</p>
        ...
        <div class="row justify-content-center my-4">
            ...
            >
                <div class="home-subject-areas">
                    <img src="{{ getFile('files/StoryWeaver family and friends.svg') }}" alt="Family & friends collection">
            ...
            >
                <div class="home-subject-areas">
                    <img src="{{ getFile('files/StoryWeaver growing up.svg') }}" alt="Growing up collection">
                    <p>@lang('Growing Up')</p>
                </div>
            </a>
            ...
            >
                <div class="home-subject-areas">
                    <img src="{{ getFile('files/StoryWeaver funny.svg') }}" alt="Funny collection">
                    <p>@lang('Funny')</p>
                </div>
            </a>
            ...
            >
                <div class="home-subject-areas">
                    <img src="{{ getFile('files/StoryWeaver STEM.svg') }}" alt="STEM collection">
                    <p>@lang('STEM')</p>
                </div>
            </a>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            >
                <div class="home-subject-areas">
                    <img src="{{ getFile('files/StoryWeaver pashto.svg') }}" alt="Pashto translation">
                    <p>@lang('Pashto')</p>
                </div>
            </a>
            ...
            >
                <div class="home-subject-areas">
                    <img src="{{ getFile('files/StoryWeaver dari.svg') }}" alt="Dari/Farsi translation" width="65" height="54">
                    <p>@lang('Dari/Farsi')</p>
                </div>
            </a>
        </div>
